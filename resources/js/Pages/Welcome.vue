    ...
    >
        ...
        <AppTheme />
            <Link
                ...
                class="text-sm text-zinc-700 dark:text-zinc-400 underline"
            >
                Dashboard
            </Link>
            ...
            <template v-else>
                ...
                <Link
                    v-if="canRegister"
                    :href="route('register')"
                    class="ml-4 text-sm text-zinc-700 dark:text-zinc-400 underline"
                >
                    Register
                </Link>
            </template>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 bg-white dark:bg-zinc-800 overflow-hidden shadow">
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        ...
                        <div class="ml-12">
                            <div
                                class="mt-2 text-zinc-600 dark:text-zinc-400 text-sm"
                            >
                    ...
                    >
                        <div class="flex items-center">
                            ...
                            <div
                                class="ml-4 text-lg leading-7 font-semibold text-zinc-900 dark:text-white"
                            >
                                Vibrant Ecosystem
                            </div>
                        </div>
            ...
            >
                ...
                <div
                    class="ml-4 text-center text-sm text-zinc-500 sm:text-right sm:ml-0"
                >
